...
@section('content')
    <div class="container">
        <main>
            ...
            <form action="{{ route('pokemon.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <input class="form-control @error('species') is-invalid @enderror" type="text" species="species"
            ...
            <a href="{{ route('pokemon.index')  }}" class="btn btn-info mt-3">Back Pokedex</a>
        </main>
    </div>
@endsection
