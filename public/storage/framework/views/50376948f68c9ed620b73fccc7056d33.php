...
unset($__errorArgs, $__bag); ?>" type="number" name="weight"
                            id="weight" value="<?php echo e(old('weight')); ?>">
                    </div>
...
unset($__errorArgs, $__bag); ?>" type="number" name="height"
                            id="height" value="<?php echo e(old('height')); ?>">
                    </div>
                    ...
                    <div class="col-6">
                        <label for="is_legendary">
                            <input class="form-check-input" type="checkbox" name="is_legendary" id="is_legendary"
                                <?php echo e(old('is_legendary') ? 'checked' : ''); ?>>
                            Is Legendary
                        </label>
                    </div>
...
unset($__errorArgs, $__bag); ?>" type="file" name="photo"
                    ...
                    <button class="btn btn-primary mt-3" type="submit">Add New Pokemon</button>
                </div>
            </form>
            <a href="<?php echo e(route('pokemon.index')); ?>" class="btn btn-info mt-3">Back to Pokedex</a>
        </main>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\uts-pokedex-2022130011\resources\views/pokemon/create.blade.php ENDPATH**/ ?>