...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <main>
            ...
            <form action="<?php echo e(route('pokemon.update', $pokemon)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="number" step="0.01"
                            name="weight" id="weight" value="<?php echo e(old('weight', $pokemon->weight)); ?>">
                    </div>
...
unset($__errorArgs, $__bag); ?>" type="number" step="0.01"
                            name="height" id="height" value="<?php echo e(old('height', $pokemon->height)); ?>">
                    </div>
...
unset($__errorArgs, $__bag); ?>" type="file" name="photo"
                            id="photo">
                        <img src="<?php echo e(Storage::url($pokemon->photo)); ?>" class="img-fluid mt-2">
                    </div>

                    <div class="col-6 mt-3">
                        <label for="is_legendary">
                            <input class="form-check-input" type="checkbox" name="is_legendary"
                                id="is_legendary" <?php echo e(old('is_legendary', $pokemon->is_legendary) ? 'checked' : ''); ?>>
                            Is Legendary
                        </label>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\uts-pokedex-2022130002\resources\views/pokemon/edit.blade.php ENDPATH**/ ?>