<?php $__env->startSection('content'); ?>
    <div class="container">
        <main>
            <div class="row">
                <div class="col-6">
                    <img src="<?php echo e(Storage::url($pokemon->photo)); ?>">
                </div>
                <div class="col-6">
            ...
            <div class="mt-4">
                ...
                <form action="<?php echo e(route('pokemon.destroy', $pokemon)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?>
                    <button class="btn btn-danger">Delete</button>
                </form>
                <a href="<?php echo e(route('pokemon.index')); ?>" class="btn btn-info">Back Pokedex</a>
            </div>
        </main>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\uts-pokedex-2022130011\resources\views/pokemon/show.blade.php ENDPATH**/ ?>